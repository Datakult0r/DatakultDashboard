...
import { Copy, ExternalLink, Check, Mail, MessageSquare, Calendar, Globe } from 'lucide-react';
 ...
 */
export default function TriageCard({ item }: TriageCardProps) {  const [isReplyExpanded, setIsReplyExpanded] = useState(false);
