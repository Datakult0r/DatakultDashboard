...
async function submitEasyApply(apiKey: string, task: BrowserUseTask): Promise<BrowserUseResult> {
  ...
  const instructions = [
    ...
    'Keep any values LinkedIn pre-filled. For empty required fields use: Name "Philippe Küng", Email "philippe.kung@clinicofai.com", Location "Zurich, Switzerland", Phone "+351 933 607 511".',
    'WORK-AUTHORIZATION STOP RULE: Philippe is a dual Swiss & Portuguese citizen — fully authorized in the EU/Switzerland with NO sponsorship needed, but NOT authorized to work in the US. If a REQUIRED work-authorization field only offers US options (US Citizen / Permanent Resident / EAD / Visa Holder) with no "require sponsorship / not authorized" choice, the role needs US work authorization Philippe lacks: STOP, do not pick a false option, finish submitted=false reason="needs_human: not_us_authorized".',
    'If asked about US citizenship, answer No. If asked about security clearance, answer None — and if clearance is required, STOP with reason="needs_human: clearance_required".',
    'Education for forms: École hôtelière de Lausanne (EHL), BSc, 2013–2016; plus MIT Schwarzman College of Computing — Data Science & Machine Learning / Data Engineering.',
    'Certifications: MIT Schwarzman College of Computing (Data Science & ML); MindStudio AI Developer Certification (2024).',
...
async function submitWebsiteApply(apiKey: string, task: BrowserUseTask): Promise<BrowserUseResult> {
  ...
  const instructions = [
    ...
    '  Location / Current City: Zurich, Switzerland',
    '  LinkedIn: https://www.linkedin.com/in/pkfde',
    '  Website: https://www.clinicofai.com',
    '  Nationality: Dual Swiss & Portuguese citizen',
    '  Work Authorization (EU/CH): Fully authorized to work in the EU and Switzerland — NO sponsorship needed.',
    '  Work Authorization (US/UK): NOT authorized; would require sponsorship. If a US role offers no "require sponsorship" option, STOP (see rule below).',
    '  US citizen: No. Security clearance: None.',
    '  Global mobility: Willing to deploy on-site (EU, UAE/Dubai, US) for 6+ months to embed with strategic customers.',
    '  Education: École hôtelière de Lausanne (EHL), BSc, 2013–2016; MIT Schwarzman College of Computing — Data Science & ML, Data Engineering.',
    '  Certifications: MIT Schwarzman College of Computing; MindStudio AI Developer Certification (2024).',
    '  Years of experience: 8+ total in software/data/AI leadership; 4+ years GenAI/LLMs in production.',
    '  Relevant skills: hybrid RAG (Weaviate, Pinecone, Cohere ReRank, BM25), LLM eval & observability (LangSmith, Evidently, Relari), multi-agent orchestration (AutoGen, LangChain, LangGraph), Python/PyTorch/TensorFlow, fine-tuning (LoRA/QLoRA/DPO/GRPO), vLLM, Docker/Kubernetes, Azure/GCP/AWS.',
    '  Salary expectation: EUR 90-130k FTE / EUR 80-150/hr contract',
    '  Notice period / Availability: Immediate (within 1 week)',
    '  Timezone: CET (UTC+1), Zurich — flexible ±3 hours',
    '  Remote: Yes (remote or hybrid; EU-based)',
    'WORK-AUTHORIZATION STOP RULE: If a REQUIRED work-authorization field only lists US options (US Citizen / Lawful Permanent Resident / EAD / Visa Holder) with no "require sponsorship / not authorized" choice, this role needs US work authorization Philippe does not have — do NOT select a false option; finish submitted=false reason="needs_human: not_us_authorized". Same for any required US security clearance.',
